...
namespace Axon.UI.Components.Base
{
    public class DelegateCommand : ICommand
    {
        ...
        public DelegateCommand(Action<object> actionWithParameter)
        {
            _executeMethodWithParameter = actionWithParameter;
        }
        ...
        public void Execute(object parameter)
        {
            try
            {
                if (_executeMethodWithParameter != null)
                {
        ...
        readonly Action<object> _executeMethodWithParameter;
    ...
    public class DelegateCommand<T> : ICommand
    {
        ...
        public DelegateCommand(Action onCleanCommand)
        {
            this.onCleanCommand = onCleanCommand;
        }
